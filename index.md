...
address: "Health Sciences Library and Informatics Center, Room 428, 2400 Marble Ave NE, Albuquerque, NM, 87131"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria"), videoconferencing URL, or 'online'
country: "us"      # lowercase two-letter ISO country code such as "fr" (see https://en.wikipedia.org/wiki/ISO_3166-1#Current_codes) for the institution that hosts the workshop
language: "en"     # lowercase two-letter ISO language code such as "fr" (see https://en.wikipedia.org/wiki/List_of_ISO_639-1_codes) for the workshop
latitude: "35.090405"        # decimal latitude of workshop venue (use https://www.latlong.net/)
longitude: "-106.618077"       # decimal longitude of the workshop venue (use https://www.latlong.net)
humandate: "May 26-27, 2026"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "9:00 a.m. - 5:00 p.m. MDT"    # human-readable times for the workshop e.g., "9:00 am - 4:30 pm CEST (7:00 am - 2:30 pm UTC)"
startdate: 2026-05-26      # machine-readable start date for the workshop in YYYY-MM-DD format like 2015-01-01
enddate: 2026-05-27        # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
instructor: ["Andres Evergreen-Reyes", "Margo Gustina", "Danielle Maurici-Pollock", "Todd Quinn", "Harry Snow", "David Gustavsen"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Maria Sanchez", "Sabrina Templeton"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: ["dmauricipollock@salud.unm.edu"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
collaborative_notes: https://pad.carpentries.org/2026-05-26-UNM # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document (e.g., https://pad.carpentries.org/2015-01-01-euphoria)
